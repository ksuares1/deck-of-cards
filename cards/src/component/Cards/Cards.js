...
let Cards =() =>{
    return(
        ...
        <div class="suit-hearts">
            <img class="suit-clubs-cards J" src={require("../../assets/img/suit-of-hearts/hearts-J.png")} alt="suit-of hearts" /> 
        </div>
        <div class="suit-hearts">
            <img class="suit-clubs-cards K" src={require("../../assets/img/suit-of-hearts/hearts-K.png")} alt="suit-of hearts" /> 
        </div>
        <div class="suit-hearts">
            <img class="suit-clubs-cards Q" src={require("../../assets/img/suit-of-hearts/hearts-Q.png")} alt="suit-of hearts" /> 
        </div>
        </div>
        </main>
